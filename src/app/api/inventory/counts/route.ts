...
export async function POST(
  ...
  try {
    ...
    //
    // Admin و General Manager:
    // يستطيعون إنشاء جرد لأي موقع داخل الشركة.
    //
    // باقي المستخدمين:
    // يستطيعون إنشاء جرد لموقعهم المرتبط بحسابهم فقط.
    // ============================================================
    ...
    // 7) التحقق من الموقع
    //
    // حتى Admin لا يستطيع إنشاء جرد لموقع تابع لشركة أخرى.
    // ============================================================
