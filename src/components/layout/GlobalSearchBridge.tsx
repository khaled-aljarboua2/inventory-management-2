...
export default function GlobalSearchBridge() {
  ...
  useEffect(() => {
    ...
    const desktopInput = document.querySelector<HTMLInputElement>(
      'header input[aria-label="البحث في النظام"]'
    );

    if (desktopInput) {
      desktopInput.placeholder = "ابحث عن صفحة في النظام...";
    }
            ...
            <div className="flex items-center justify-between border-b border-slate-100 px-4 py-3 dark:border-slate-800">
              <div>
                ...
                <p className="mt-0.5 text-xs text-slate-400">
                  وصول سريع إلى الصفحة التي تريدها
                </p>
              </div>
            ...
            <form onSubmit={handleSubmit} className="p-4">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="مثال: المنتجات، المخزون، التقارير..."
